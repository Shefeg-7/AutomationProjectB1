...
import com.loop.test.day10_jsexecutor_pom.LoopPracticeDynamicLoadingPage;
...
public class To_dynamic_loading1 {
    /*
     ...
     */
    LoopPracticeDynamicLoadingPage1 loopPracticeDynamicLoading1;

    @BeforeMethod
    public void setUp() {
        loopPracticeDynamicLoading1 = new LoopPracticeDynamicLoadingPage1();
    ...
    public void dynamic_loading_1() {
        ...
        BrowserUtils.waitForClickable(loopPracticeDynamicLoading1.dynamicLoading1, 5);
        BrowserUtils.waitForClickable(loopPracticeDynamicLoading1.startButton, 5);
        ...
        loopPracticeDynamicLoading1.username.sendKeys(ConfigurationReader.getProperty("dynamicLoading.incorrectPassword"));
